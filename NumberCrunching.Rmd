...
#for some reason when I just did a straight read_csv, the columns indicated in the col_types section didn't get pulled in with the rest of the data...this seems to fix it.
```
...
```{r}
Trees$UniqueID<-paste(Trees$Observer,Trees$`Tree ID`, Trees$Species, Trees$Latitude, Trees$Longitude, Trees$Urbanization, Trees$Habitat, Trees$Shading, Trees$Circumference, sep = "_")
```
